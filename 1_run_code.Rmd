...
4. Normalize each dataset separately with SCTransform. Regress out percent.mito if desired. 
5. Calculate cell cycle scores. 
6. Prepare for integration with SelectIntegrationFeatures() and PrepSCTIntegration(). 
